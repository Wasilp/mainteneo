    ...
    <v-content>
        ...
        <v-container grid-list-xl fluid v-show="showDashboard">
            <v-layout row wrap>
                ...
                <v-flex xs3>
                    <mini-statistic icon="battery_full" :title="this.tanksItems.length+''" :sub-title="this.$i18n.t('views.dashboard.tanksInStock')" color="secondary"></mini-statistic>
                </v-flex>
                <v-flex xs9>
                    <v-spacer></v-spacer>
                </v-flex>
                ...
                <v-flex lg6 sm12 xs12>
                    <v-widget :title="this.$i18n.t('views.dashboard.inventoryViewGraph.title')" content-bg="white">
                ...
                <v-flex lg6 sm12 xs12>
                    <v-widget :title="this.$i18n.t('views.dashboard.inventoryCircleViewGraph.title')" content-bg="white">
                        <div slot="widget-content">
    ...
    methods: {
          ...
          if (error) {
            ...
            if (this.inventoryByGas.length > 0) {
              this.inventoryByGas.forEach(item => {
                ...
                this.inventoryDataBarPlotView.legend.push(item.gas);
        ...
        populateViewComponents() {
            ...
            if (this.inventoryByGas.length > 0) {
                ...
                console.log(this.$refs.inventoryBarPlotChart.chart, 'bar')
                this.$refs.inventoryBarPlotChart.chart.setOption({
                    xAxis: [{
                        type: "category",
                        data: this.inventoryDataBarPlotView.legend
                ...
                console.log(this.$refs.inventoryCircleChart, 'circle')
                this.$refs.inventoryCircleChart.chart.setOption({
                    series: {
                        data: this.inventoryDataCircleView
                    }
