...
<v-card>
    <v-toolbar card color="white">
        <v-text-field flat solo prepend-icon="search" :placeholder="this.$i18n.t('dataTables.employeesTable.search')" v-model="search" hide-details class="hidden-sm-and-down"></v-text-field>
        <v-btn icon>
    ...
    <v-card-text class="pa-0">
        <v-data-table :headers="headers" :search="search" :items="usersItems" :rows-per-page-items="[10,25,50,{text:'All','value':-1}]" class="elevation-1" item-key="id">
