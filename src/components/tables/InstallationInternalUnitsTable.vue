...
<v-card>
    <v-toolbar card color="white">
        <v-text-field flat solo prepend-icon="search" :placeholder="this.$i18n.t('dataTables.installationInternalUnitsTable.search')" v-model="search" hide-details class="hidden-sm-and-down"></v-text-field>
        <v-btn icon>
    ...
    <v-card-text class="pa-0">
        <v-data-table :headers="headers" :search="search" :items="internalUnits" :rows-per-page-items="[10,25,50,{text:'All','value':-1}]" :pagination.sync="pagination" class="elevation-" item-key="id">
